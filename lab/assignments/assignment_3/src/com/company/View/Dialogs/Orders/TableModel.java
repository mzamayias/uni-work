...
public class TableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        try {
            ...
            switch (columnIndex) {
                case 0 -> returnValue = resultSet.getString(columnNames[0]);
                case 1 -> returnValue = resultSet.getString(columnNames[1]);
                case 2 -> returnValue = resultSet.getString(columnNames[2]);
                case 3 -> returnValue = resultSet.getString(columnNames[3]);
                case 4 -> returnValue = resultSet.getString(columnNames[4]);
            }
