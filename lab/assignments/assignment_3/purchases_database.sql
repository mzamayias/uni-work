CREATE DATABASE IF NOT EXISTS `purchases` DEFAULT CHARACTER SET utf8;
USE `purchases`;
...
INSERT INTO `customer` (`customer_id`, `last_name`, `first_name`, `afm`, `telephone`)
...
INSERT INTO `purchase` (`purchase_id`, `customer_id`, `inventory_id`, `quantity`, `price`)
VALUES (13, 1, 1, 6, 0);
INSERT INTO `purchase` (`purchase_id`, `customer_id`, `inventory_id`, `quantity`, `price`)
